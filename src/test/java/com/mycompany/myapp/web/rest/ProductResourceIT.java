...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        Product product = new Product().name(DEFAULT_NAME).ean(DEFAULT_EAN);
        return product;
    }
    ...
    public static Product createUpdatedEntity() {
        Product product = new Product().name(UPDATED_NAME).ean(UPDATED_EAN);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).ean(UPDATED_EAN);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testProductSearch.getEan()).isEqualTo(UPDATED_EAN);
            });
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).ean(UPDATED_EAN);

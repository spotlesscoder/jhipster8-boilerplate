...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipster8BoilerplateApp.product.delete.question">
        <Translate contentKey="jhipster8BoilerplateApp.product.delete.question" interpolate={{ id: productEntity.id }}>
